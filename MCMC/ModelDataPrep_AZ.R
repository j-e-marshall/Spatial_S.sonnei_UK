...
data$AzithromycinR[is.na(data$AzithromycinR)] <- 0
## Add label bucket 

data$amr_type = NA
data$amr_type = rep('0', length(data$AzithromycinR))

data$amr_type[which(is.na(match(data$AzithromycinR, 1)) == F& is.na(match(data$Group, "Travel")) == F)] = 'AMR'
data$amr_type[which(is.na(match(data$AzithromycinR, 0)) == F& is.na(match(data$Group, "Travel")) == F)] = 'Non'
data$amr_type[which(is.na(match(data$AzithromycinR, 1)) == F& is.na(match(data$Group, "non-pMSM")) == F)] = 'AMR'
data$amr_type[which(is.na(match(data$AzithromycinR, 0)) == F& is.na(match(data$Group, "non-pMSM")) == F)] = 'Non'
data$amr_type[which(is.na(match(data$AzithromycinR, 1)) == F& is.na(match(data$Group, "pMSM")) == F)] = 'AMR'
data$amr_type[which(is.na(match(data$AzithromycinR, 0)) == F& is.na(match(data$Group, "pMSM")) == F)] = 'Non'

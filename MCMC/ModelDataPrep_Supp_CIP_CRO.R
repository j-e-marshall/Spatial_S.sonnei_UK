...
data$CIP[is.na(data$CIP)] <- 0

## Add label bucket 
data$amr_type = NA
data$amr_type = rep('0', length(data$CIP))

data$amr_type[which(is.na(match(data$CIP, 1)) == F& is.na(match(data$Group, "Travel")) == F)] = 'AMR'
data$amr_type[which(is.na(match(data$CIP, 0)) == F& is.na(match(data$Group, "Travel")) == F)] = 'Non'
data$amr_type[which(is.na(match(data$CIP, 1)) == F& is.na(match(data$Group, "non-pMSM")) == F)] = 'AMR'
data$amr_type[which(is.na(match(data$CIP, 0)) == F& is.na(match(data$Group, "non-pMSM")) == F)] = 'Non'
data$amr_type[which(is.na(match(data$CIP, 1)) == F& is.na(match(data$Group, "pMSM")) == F)] = 'AMR'
data$amr_type[which(is.na(match(data$CIP, 0)) == F& is.na(match(data$Group, "pMSM")) == F)] = 'Non'
...
################################################################################
## Save data 
#saveRDS(data.MCMC, 'Data_model_independent_CIP.rds')
...
data <- hptgeocode3 
data$year<- as.numeric(data$year)
data$CRO[is.na(data$CRO)] <- 0
## Add label bucket 

data$amr_type = NA
data$amr_type = rep('0', length(data$CRO))

data$amr_type[which(is.na(match(data$CRO, 1)) == F& is.na(match(data$Group, "Travel")) == F)] = 'AMR'
data$amr_type[which(is.na(match(data$CRO, 0)) == F& is.na(match(data$Group, "Travel")) == F)] = 'Non'
data$amr_type[which(is.na(match(data$CRO, 1)) == F& is.na(match(data$Group, "non-pMSM")) == F)] = 'AMR'
data$amr_type[which(is.na(match(data$CRO, 0)) == F& is.na(match(data$Group, "non-pMSM")) == F)] = 'Non'
data$amr_type[which(is.na(match(data$CRO, 1)) == F& is.na(match(data$Group, "pMSM")) == F)] = 'AMR'
data$amr_type[which(is.na(match(data$CRO, 0)) == F& is.na(match(data$Group, "pMSM")) == F)] = 'Non'
...
data.MCMCCRO = list(nb_genotypes = nb_clades,
                 nb_years = nb_years,
                 nb_groups = nb_groups,
                 data_genotype_non_ref = clade_number_array_paired,
                 data_genotype_ref = clade_number_array_ref1,
...
################################################################################
## Save data 
#saveRDS(data.MCMCCRO, 'Data_model_independent_CRO.rds')

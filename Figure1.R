...
#read in tree
bigtree<- read.tree("Ssonnei_B_tree.nwk")
...
dat = readRDS(file = 'ssonneigeospatialbacdate030524.rds')
...
#save tree
#ggsave("tree_fig1_121625.pdf",p1, height = 6, width = 4)
...
totbucketssum <- data.frame(hptgeocode3) %>% dplyr::select(Group,CiprofloxacinR, AzithromycinR, ESBLR) 
totbucketssum$ESBLR[totbucketssum$ESBLR ==0] <- "S"
totbucketssum$ESBLR[totbucketssum$ESBLR ==1] <- "R"
totbucketssum$AzithromycinR[totbucketssum$AzithromycinR ==0] <- "S"
totbucketssum$AzithromycinR[totbucketssum$AzithromycinR ==1] <- "R"
totbucketssum$CiprofloxacinR[totbucketssum$CiprofloxacinR ==0] <- "S"
totbucketssum$CiprofloxacinR[totbucketssum$CiprofloxacinR ==1] <- "R"
